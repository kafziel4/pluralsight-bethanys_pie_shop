...
namespace BethanysPieShopTests.Mocks
{
    ...
    {
        public static IPieRepository GetPieRepository()
        {
            ...
            var mockPieRepository = Substitute.For<IPieRepository>();
            mockPieRepository.AllPies.Returns(pies);
            mockPieRepository.PiesOfTheWeek.Returns(pies.Where(p => p.IsPieOfTheWeek));
            mockPieRepository.GetPieById(default).ReturnsForAnyArgs(pies[0]);
        ...
        public static ICategoryRepository GetCategoryRepository()
        {
            ...
            mockCategoryRepository.AllCategories.Returns(categories);
